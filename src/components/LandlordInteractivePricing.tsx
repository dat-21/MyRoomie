                        ...
                        {CONTACT_PACKS.map(pack => {
                            ...
                            return (
                                <motion.button
                                    ...
                                    className={`relative text-left p-4 rounded-2xl border-2 transition-all cursor-pointer ${isSelected
                                ...
                                {BOOST_QUANTITIES.map(q => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors border-2 ${isDisabled
                                ...
                                {BOOST_DURATIONS.map(dur => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`text-left p-3 rounded-xl border-2 transition-colors flex justify-between items-center ${isDisabled
                        ...
                        {GOLD_SUBSCRIPTIONS.map(gold => {
                            ...
                            return (
                                <motion.button
                                    ...
                                    className={`relative text-left p-5 rounded-2xl border-2 transition-all cursor-pointer ${isSelected
